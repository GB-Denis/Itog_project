...
public class Operation {
        ...
        public boolean notebookIsCorrect(Notebook notebook)
        {
            for (Criterion criterion : criterionList) {
                ...
                else if (criterion.property.equals("amountOZU"))
                {
                    valueNotebook = notebook.getOZU();
                }
                else if (criterion.property.equals("hardDisc"))
                {
                    valueNotebook = notebook.getHardDisc();
                }
        ...
        public Map<String, String> descriptionsProperties()
        {
            ...
            map.put("name", "по Id");
            map.put("amountOZU", "Объем оперативной памяти");
            map.put("hardDisc", "Объем жёсткого диска");
